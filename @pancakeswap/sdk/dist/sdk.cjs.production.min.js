...
var v,
  y = '0xbcaebde6d8d9f3f74eac5c75fde2768390ff5ae0f8c78c71b8568e2d79036dc2',
  w = i.BigInt(1e3),
  T = i.BigInt(0),
  g = i.BigInt(1),
  k = i.BigInt(2),
...
var $,
  ...
  G = (z.ETHER = new z(18, 'BNB', 'BNB')),
  K = (function (t) {
    function e(e, n, r, o, i) {
      var u
      return ((u = t.call(this, r, o, i) || this).chainId = e), (u.address = Y(n)), u
    }
    U(e, t)
    var n = e.prototype
    return (
...
var tt,
  ...
  at = (function () {
    function t(t, e) {
      void 0 === e && (e = g), (this.numerator = J(t)), (this.denominator = J(e))
    }
    var e = t.prototype
    return (
      (e.invert = function () {
    ...
    return (
      ...
      (e.getLiquidityMinted = function (t, e, n) {
        ...
        if (((o[0].token.equals(this.token0) && o[1].token.equals(this.token1)) || u(!1), i.equal(t.raw, T)))
          r = i.subtract(Q(i.multiply(o[0].raw, o[1].raw)), w)
        else {
        ...
        if (
          ...
          if (i.equal(s, T)) a = e
            ...
            if (i.greaterThan(c, f)) {
              var d = i.multiply(e.raw, i.subtract(c, f)),
                l = i.add(i.multiply(c, A), f),
                p = i.divide(d, l)
              a = e.add(new ft(this.liquidityToken, p))
            } else a = e
          }
        } else a = e
    ...
    (t.bestTradeExactIn = function (e, n, r, o, i, a, s) {
      ...
      for (var m = Tt(n, h), v = gt(r, h), y = 0; y < e.length; y++) {
        ...
        if (
          ...
          if (g.token.equals(v))
            V(s, new t(new ht([].concat(i, [w]), a.currency, r), a, exports.TradeType.EXACT_INPUT), d, wt)
          else if (p > 1 && e.length > 1) {
            var k = e.slice(0, y).concat(e.slice(y + 1, e.length))
            t.bestTradeExactIn(k, g, r, { maxNumResults: d, maxHops: p - 1 }, [].concat(i, [w]), a, s)
          }
        }
      }
      return s
    ...
    (t.bestTradeExactOut = function (e, n, r, o, i, a, s) {
      ...
      for (var m = Tt(r, h), v = gt(n, h), y = 0; y < e.length; y++) {
        ...
        if (
          ...
          if (g.token.equals(v))
            V(s, new t(new ht([w].concat(i), n, a.currency), a, exports.TradeType.EXACT_OUTPUT), d, wt)
          else if (p > 1 && e.length > 1) {
            var k = e.slice(0, y).concat(e.slice(y + 1, e.length))
            t.bestTradeExactOut(k, n, g, { maxNumResults: d, maxHops: p - 1 }, [w].concat(i), a, s)
          }
        }
      }
      return s
...
var At,
      ...
      (t.swapCallParameters = function (t, e) {
        ...
        switch (t.tradeType) {
          ...
          case exports.TradeType.EXACT_OUTPUT:
            p && u(!1),
              n
                ? ((o = 'swapETHForExactTokens'), (i = [f, d, s, l]), (a = c))
                : r
                ? ((o = 'swapTokensForExactETH'), (i = [f, c, d, s, l]), (a = '0x0'))
                : ((o = 'swapTokensForExactTokens'), (i = [f, c, d, s, l]), (a = '0x0'))
        }
  ...
  bt = (((At = {})[exports.ChainId.MAINNET] = { '0xE0B7927c4aF23765Cb51314A0E0521A9645F0E2A': 9 }), At),
  qt = (function () {
    function t() {}
    return (
        ...
        try {
          ...
          return Promise.resolve(
            s
              ? a(bt[t][e])
              : Promise.resolve(
                  new l.Contract(e, Ot, n).decimals().then(function (n) {
                    var r, o, i
                    return (
                      (bt = _(
                        {},
      ...
      (t.fetchPairData = function (t, e, n) {
        try {
          ...
          return Promise.resolve(new l.Contract(r, m.abi, n).getReserves()).then(function (n) {
            ...
            return new pt(new ft(t, i[0]), new ft(e, i[1]))
          })
        } catch (t) {
          return Promise.reject(t)
        }
...
;(exports.JSBI = i),
  ...
  (exports.ETHER = G),
  (exports.FACTORY_ADDRESS = '0x907e8c7d471877b4742da8aa53d257d0d565a47e'),
  (exports.Fetcher = qt),
  (exports.Fraction = at),
